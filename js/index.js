  ...
  onmouseout="this.src='${data.imageUrls}'" style = "height:260px;cursor: pointer;">
                    ...
                    <div class="text-center py-4" style = "cursor: pointer;">
                        ...
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h5><span style="font-weight: bold;">tk ${data.price}.00 </span><span style="font-size: 13px;">( ${data.weight} )</span></h5>
...
db.collection('fish').where('status', '==', 'Active').get().then((snapshot) => {
  ...
  onmouseout="this.src='${data.imageUrls[0]}'" style = "height:260px;cursor: pointer;">
   ...
   <div class="overlay-text" style="display:${content};">${data.otype}</div>
                    ...
                    <div class="text-center py-4" style = "cursor: pointer;" >
                        ...
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            ...
                            <h5><span style="font-weight: bold;">tk ${data.price}.00 </span><span style="font-size: 13px;">( ${data.size} )</span></h5>
